<template>
	<div class="mb-4">
		<textarea class="block w-full text-sm text-gray-900 bg-white py-2 px-4 appearance-none placeholder-gray-500 border border-solid rounded resize-none focus:outline-none bg-white" rows="5" @keyup="showSubmitButton" v-model="post.content" :autofocus="true"></textarea>
